    ...
    <>
      <div className="bg-gradient-to-r from-green-400 to-blue-500 text-white py-20 px-4">
        <div className="max-w-7xl mx-auto flex flex-col items-center">
          {/* Heading */}
          <h1 className="text-5xl font-bold text-center">Money Champ</h1>
          ...
          <button
            ...
            className="mt-8 px-6 py-3 bg-white text-green-500 font-semibold rounded-lg shadow-md hover:bg-gray-100 transition duration-300"
          >
            Get Started
          </button>
        </div>
      ...
      <div className="bg-gray-100 py-20 px-4">
        ...
        <div className="mt-10 max-w-4xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8">
          <div className="bg-white p-6 rounded-lg shadow-lg">
            ...
            <p className="mt-4 font-bold">- Harsh Kumar Singh</p>
          </div>
          <div className="bg-white p-6 rounded-lg shadow-lg">
            <FaQuoteLeft className="text-xl text-gray-400" />
            <p className="mt-4">
              "Finally, an easy way to manage and record my finances. The
              insights feature is a game changer!"
            </p>
            <p className="mt-4 font-bold">- Pijush Kumar</p>
          </div>
        </div>
      </div>
      {/* CTA */}
